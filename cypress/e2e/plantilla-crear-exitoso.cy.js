...
describe('AgendaYA - M06 Plantillas de Email', () => {
  ...
  it('crea la primera plantilla del tipo y queda marcada como por defecto', () => {
    ...
    cy.get('[data-cy="asunto-input"]').type('Tu reserva con {nombre_profesional} está confirmada')
    cy.get('[data-cy="saludo-input"]').type('Hola {nombre_invitado}, gracias por reservar.')
